...
const AppContent = () => {
  ...
  return (
      <>
      {!location.pathname.startsWith('/university/') ? <Navbar /> : <UniNarbar/>}
      <ToastContainer 
        position="top-right"
        autoClose={5000}
      ...
      {location.pathname.startsWith('/courses') ? null : location.pathname.startsWith('/university/') ? <UniFooter /> : <Footer />}

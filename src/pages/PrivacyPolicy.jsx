    ...
    <div className="bg-gray-100 py-16 sm:py-20">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 bg-white rounded-lg shadow-md p-8 sm:p-12">
        ...
        <div className="prose max-w-none">
          ...
          <h2 className="text-2xl font-bold text-gray-800 mt-8 mb-3">Information We Collect</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-gray-800 mt-8 mb-3">Cookies & Third-Party Advertising</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-gray-800 mt-8 mb-3">External Links</h2>
          <p>
            ...
            or content of other websites. We encourage you to read their
            privacy policies.
          </p>

          <h2 className="text-2xl font-bold text-gray-800 mt-8 mb-3">How We Use Information</h2>
          ...
          <h2 className="text-2xl font-bold text-gray-800 mt-8 mb-3">Security</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-gray-800 mt-8 mb-3">Sharing of Information</h2>
          ...
          <ul className="list-disc ml-6">
            ...
            <li>
              With trusted partners who help us operate the site (such as analytics or ad providers)
            </li>
          </ul>

          <h2 className="text-2xl font-bold text-gray-800 mt-8 mb-3">Changes to This Policy</h2>
          <p>
          ...
          <p>For any questions about this policy, please contact us at: <a href="mailto:9jaschoolshub@gmail.com" className="text-blue-600 hover:underline">9jaschoolshub@gmail.com</a></p>
        </div>
      </div>
    </div>
  );

...
/*Todo
- Implement conditional rendering using clerk's auth elements
- Aftter signin, save auth token with zuztand. Create a useStore.js file for this and save in a hooks folder
- Admin dasboard currently supports adding a university alone, implement update and delete uni functions with a confirmation modal for deleting uni
*/
  return (
    <div className="ml-6 p-10">
      ...
      <form action="" onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-0.5 mt-4 max-w-xl">
          <label htmlFor="universityType" className="font-semibold">
            University Type
          </label>
          <select
            name="universityType"
        ...
        <div className="flex flex-col gap-0.5 mt-4 max-w-xl">
          <label htmlFor="coursesOffered" className="font-semibold">

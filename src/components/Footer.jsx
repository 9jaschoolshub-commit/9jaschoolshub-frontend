          ...
          <div className="flex flex-col sm:flex-row justify-between mb-8">
            <div>
              ...
              <div className="hidden md:flex space-x-4">
                <a
                  href="https://www.x.com/9jaschoolshub"
                  target="_blank"
                ...
                <a
                  href="https://www.linkedin.com/company/sqwads"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                ...
                <a
                  href="https://www.instagram.com/9jaschoolshub"
                  target="_blank"
                  rel="noopener noreferrer"
                >
            ...
            <div className="flex flex-col sm:flex-row gap-8">
              ...
              <div>
                ...
                <ul className="space-y-2 text-sm text-gray-50">
                  <div className="flex ">
                    <MapPinIcon />
                    <li className="ml-2">Lagos, Nigeria</li>
                  </div>
                  <div className="flex ">
                    <Phone />
                    <li className="ml-2"> +234 700 221 4321</li>
                  </div>
                  <div className="flex ">
                    <Mail />
                    <li className="ml-2"> 9jaSchoolsHub@gmail.com</li>
                  </div>
                  <div className="flex ">
                    <Clock />
                    <li className="ml-2"> Mon - Fri: 8:00 AM- 6:00 PM</li>
                  </div>
                </ul>
              </div>
            </div>
